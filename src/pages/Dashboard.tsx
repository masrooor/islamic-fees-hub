...
import { Users, DollarSign, AlertCircle, TrendingUp, Plus, CreditCard, GraduationCap, Briefcase, Banknote, Clock } from "lucide-react";
...
export default function Dashboard() {
  ...
  const { loans, updateLoan, addLoan } = useTeacherLoans();
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Overview of your education center</p>
        </div>
      ...
      <Tabs defaultValue="students" className="space-y-4">
        <TabsList>
          <TabsTrigger value="students" className="gap-1"><GraduationCap className="h-4 w-4" /> Students</TabsTrigger>
          <TabsTrigger value="teachers" className="gap-1"><Briefcase className="h-4 w-4" /> Teachers</TabsTrigger>
        </TabsList>
